...
const int AUDIOHANDLER_G_CHANNELS = 512;
const int AUDIOHANDLER_N_CHANNELS = 8;
const int AUDIOHANDLER_RESERVE_CHANNELS = 65;
...
const int AUDIOHANDLER_PLAYER_TO   = 60;

const int AUDIOHANDLER_VOICE_TAG  = 3;
const int AUDIOHANDLER_VOICE_FROM = 61;
const int AUDIOHANDLER_VOICE_TO   = 63;

const int AUDIOHANDLER_ALERT_TAG   = 4;
const int AUDIOHANDLER_ALERT_CHAN  = 64;
